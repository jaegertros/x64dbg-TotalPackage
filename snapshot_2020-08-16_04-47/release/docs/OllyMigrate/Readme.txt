...
- Receive debuggee with existing idb file (IDA Pro)
  ...
  Drag and drop available to copy idb file path to args. (except IDA Pro and x64dbg, use FileArg button)
...
- IDA Pro limitation (32bit build)
...
- Got New debugger startup failed Error
  In almost every case, destination debugger require high integrity level but source debugger does not.
  Run source debugger as high integrity level by UAC elevation.
